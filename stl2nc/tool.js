...
export function tool_factory()
{
    ...
    tool_library.push(new Tool(27,   1.0, inch_to_mm(50), inch_to_mm(30), "ball", 0.5, 0.0, 0.1));
    tool_library.push(new Tool(28,   0.5, inch_to_mm(50), inch_to_mm(30), "ball", 0.5, 0.0, 0.05)); 
