...
extern void set_tool(const char *name, double diameter_inch, double stepover_inch, double maxdepth_inch, double feedrate_ipm, double plungerate_ipm);
extern double get_tool_diameter(void);
extern double get_tool_stepover(void);
extern double get_tool_maxdepth(void);
extern void set_retract_height(double _rh_inch);
