...
import * as gcodeinput from './gcodeinput.js';
"use strict";
...
function load_stl(evt) 
{
    ...
    if (evt.target.readyState == FileReader.DONE) {
        reset_globals();        
        stl.process_data(evt.target.result);    
...
function load_gcode(evt) 
{
    ...
    if (evt.target.readyState == FileReader.DONE) {
        gcodeinput.process_data(evt.target.result);    
